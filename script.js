  ...
  window.onload = function() {
    ...
    document.getElementById('link4').addEventListener('click', function(e) {
      ...
      document.getElementById('chapter2Link').addEventListener('click', function(e) {
        e.preventDefault();
        loadMainContent('<iframe src="https://docs.google.com/presentation/d/e/2PACX-1vTn841Ne95gmqNAld0sUyIlxDel0rCmRxAQUzUwIhN8d6DYdfPWeQwlcdLKS9GegQ/pub?start=false&loop=false&delayms=3000" frameborder="0" width="960" height="749" allowfullscreen="true" mozallowfullscreen="true" webkitallowfullscreen="true"></iframe>');
      });
