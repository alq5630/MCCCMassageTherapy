document.addEventListener('DOMContentLoaded', function() {
  ...
  window.onload = function() {
    ...
    document.getElementById('link1').addEventListener('click', function(e) {
      ...
      loadMainContent('<iframe src="https://docs.google.com/document/d/e/2PACX-1vRjbexa2T73Fp13FG1ABA6HgUxlwGET5xueH6snvvRs0rNuRhwJmbu4mWhdgR_P1mOR2vY-gwxbeZym/pub?embedded=true" width="100%" height="600px"></iframe>');
    });
    ...
    document.getElementById('link4').addEventListener('click', function(e) {
      ...
      document.getElementById('chapter2Link').addEventListener('click', function(e) {
        e.preventDefault();
        loadMainContent('<iframe src="https://docs.google.com/presentation/d/e/2PACX-1vTn841Ne95gmqNAld0sUyIlxDel0rCmRxAQUzUwIhN8d6DYdfPWeQwlcdLKS9GegQ/pubembed?start=false&loop=false&delayms=60000" frameborder="0" width="960" height="749" allowfullscreen="true" mozallowfullscreen="true" webkitallowfullscreen="true"></iframe>');
      });
